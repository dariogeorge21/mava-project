...
/**
 * Panel for managing flights in the admin dashboard with modern UI design
 */
public class FlightManagementPanel extends JPanel {
    ...
    private void initializeComponents() {
        ...
        String[] columnNames = {"Flight Code", "Airline", "Route", "Departure", "Arrival", "Price", "Capacity"};
        ...
        flightsTable.getColumnModel().getColumn(1).setPreferredWidth(140); // Airline
        flightsTable.getColumnModel().getColumn(2).setPreferredWidth(200); // Route
        ...
        flightsTable.getColumnModel().getColumn(5).setPreferredWidth(100); // Price
        flightsTable.getColumnModel().getColumn(6).setPreferredWidth(80);  // Capacity

        // Add custom cell renderers
        flightsTable.getColumnModel().getColumn(0).setCellRenderer(new FlightCodeCellRenderer());
        flightsTable.getColumnModel().getColumn(5).setCellRenderer(new PriceCellRenderer());
        ...
        searchField = createStyledTextField("Search flights by code, airline, or route...");
    ...
    private void displayFlights(List<Flight> flightList) {
        ...
        for (Flight flight : flightList) {
            Object[] row = {
                ...
                flight.getCompanyName() != null ? flight.getCompanyName() : "N/A",
                flight.getRoute() != null ? flight.getRoute() : "Route TBD",
    ...
    private void searchFlights() {
        ...
        if (searchTerm.isEmpty() || searchTerm.equals("Search flights by code, airline, or route...")) {
            displayFlights(flights);
            return;
        }
        ...
        List<Flight> filteredFlights = flights.stream()
            .filter(flight ->
                ...
                (flight.getRoute() != null && flight.getRoute().toLowerCase().contains(searchTerm.toLowerCase()))
            )
    ...
    private JPanel createHeaderSection() {
        ...
        JLabel subtitleLabel = new JLabel("Manage flight schedules, routes, and availability");
    ...
    private JPanel createContentSection() {
        ...
        // Table title
        JLabel tableTitle = new JLabel("Flight Schedule Network");
    ...
    private JPanel createActionSection() {
        ...
        deleteFlightButton.setPreferredSize(new Dimension(150, 40));
    ...
    /**
     * Custom cell renderer for flight code column
     */
    private static class FlightCodeCellRenderer extends DefaultTableCellRenderer {
        @Override
