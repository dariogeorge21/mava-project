...
Here are screenshots of the main dashboard interfaces for each user role:

### Admin Dashboard
The administrator dashboard provides comprehensive management capabilities with tabbed panels for users, airports, airlines, flights, bookings, and system reports.

![Admin Dashboard](docs/admin-dashboard.jpeg)

### Flight Owner Dashboard  
The airline owner dashboard allows flight operators to manage their fleet, view booking statistics, and update their airline profile information.

![Owner Dashboard](docs/owner-dashboard.jpeg)

### Passenger Dashboard
The user dashboard enables passengers to search flights, make bookings, view their booking history, and manage their personal profile.

![User Dashboard](docs/user-dashboard.jpeg)
